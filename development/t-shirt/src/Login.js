...
function Login() {
  ...
  const { setlogin, setname } = useContext(contexts);
    ...
    if (email == "") {
      ...
      fetch("http://localhost:100/user")
        ...
        .then((data) => {
          ...
          if (!obj) {
            toast.error('wrong email and password plese re enter', {
              position: "top-center",
              autoClose: 2000,
             ...
             toast.success('🦄 Wellcome to user', {
              position: "top-center",
              autoClose: 2000,
              hideProgressBar: false,
              closeOnClick: true,
          ...
          <div className="card border-light-subtle shadow-sm">
            <div className="row g-0">
              <div className="col-12 col-md-6">
                <img className="img-fluid rounded-start w-100 h-100 object-fit-cover" loading="lazy" src="https://bootstrapbrain.com/demo/components/logins/login-4/assets/img/logo-img-1.webp" alt="BootstrapBrain Logo" />
              </div>
              <div className="col-12 col-md-6">
                  ...
                  <form action="#!" onSubmit={handlesubmit}>
                    <div className="row gy-3 gy-md-4 overflow-hidden">
                      ...
                      <div className="col-12">
                        ...
                        <input type="password" className="form-control" name="password" id="password" value="" required value={password}
                  ...
                  <div className="row">
                    <div className="col-12">
                      ...
                      <div className="d-flex gap-2 gap-md-4 flex-column flex-md-row justify-content-md-end">
                        <Link to={"/"}>← Home</Link>
                        <Link to={"/regi"} href="#!" className="link-secondary text-decoration-none">Create new account</Link>
