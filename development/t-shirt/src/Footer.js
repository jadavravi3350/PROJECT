    ...
    <div>
      <div className='mt-5'>
        <div className=' d-flex flex-wrap justify-content-center  border '>
          <div className='col-12 col-lg-4 bg-dark text-light text-center py-4 border'>
            <h3 className='my-5'><a href="#" style={{ textDecoration: "none", color: "white" }}>T SHOP</a></h3>
            <p>info@mysite.com</p>
            <p>Tel: 123-456-7890</p>
          </div>

          <div className='col-12 col-lg-8 d-flex border justify-content-center'>
            <div className='col-4'>
              <ul>
                <li className='my-3'><b>Shop</b></li>
                <li><Link to={"/new"} style={{ textDecoration: "none" }}>New</Link></li>
                <li><Link to={"/women"} style={{ textDecoration: "none" }}>Woman</Link></li>
            ...
            <div className='col-4'>
              <div>
                <ul>
                  <li className='my-3'><b>Our Store</b></li>
                  <li>About Us</li>
                  <li>Subscribe</li>
                  <li>FAQ</li>
            ...
            <div className='col-4'>
              <ul>
                <li className='my-3'><b>Terms & Conditions</b></li>
                <li>Store Policy</li>
          ...
          <div className='col-4 col-lg-4 row align-items-center'>
          ...
          <div className='col-12 col-lg-8  text-center py-3' style={{ background: "#D6FF38" }}>
            <p>© 2035 by T Shop. Powered and secured by Wix</p>
          </div>
